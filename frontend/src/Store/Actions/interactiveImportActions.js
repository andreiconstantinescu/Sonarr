...
import createSetClientSideCollectionSortReducer from 'Store/Reducers/Creators/createSetClientSideCollectionSortReducer';
import createFetchHandler2 from './Creators/createFetchHandler2';
...
export const actionHandlers = handleThunks({
  ...
  [FETCH_INTERACTIVE_IMPORT_EPISODES]: createFetchHandler2('interactiveImport.episodes', '/episode')
});
